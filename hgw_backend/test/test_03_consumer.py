...
from hgw_backend.management.commands.create_connector_consumer import Command
...
class TestConsumer(GenericTestCase):
    ...
    def setUp(self):
        ...
        [{'profile': {'code': 'PROF002', 'version': 'hgw.document.profile.v0', 'start_time_validity': '2017-06-23T10:13:39Z', 'end_time_validity': '2018-06-23T23:59:59Z', 'payload': '{"clinical_domain": "Laboratory"}'}, 'person_identifier': 'AAAABBBBCCCCDDDD', 'dest_public_key': '-----BEGIN PUBLIC KEY-----\\nXQIDAQAB\n-----END PUBLIC KEY-----', 'channel_id': 'KKa8QqqTBGePJStJpQMbspEvvV4LJJCY', 'start_validity': '2017-10-23', 'expire_validity': '2018-10-23'},
         {'profile': {'code': 'PROF002', 'version': 'hgw.document.profile.v0', 'payload': '{"clinical_domain": "Laboratory"}'}, 'person_identifier': 'AAAABBBBCCCCDDDD', 'dest_public_key': '-----BEGIN PUBLIC KEY-----\\nXQIDAQAB\n-----END PUBLIC KEY-----', 'channel_id': 'KKa8QqqTBGePJStJpQMbspEvvV4LJJCY', 'start_validity': None, 'expire_validity': None}]

        [{'profile': {'code': 'PROF002', 'version': 'hgw.document.profile.v0', 'start_time_validity': '2017-06-23T10:13:39Z', 'end_time_validity': '2018-06-23T23:59:59Z', 'payload': '{"clinical_domain": "Laboratory"}'}, 'person_identifier': 'AAAABBBBCCCCDDDD', 'dest_public_key': '-----BEGIN PUBLIC KEY-----\\nXQIDAQAB\n-----END PUBLIC KEY-----', 'channel_id': 'KKa8QqqTBGePJStJpQMbspEvvV4LJJCY', 'start_validity': '2017-10-23T10:00:54+02:00', 'expire_validity': '2018-10-23T10:00:00+02:00'},
         {'profile': {'code': 'PROF002', 'version': 'hgw.document.profile.v0', 'payload': '{"clinical_domain": "Laboratory"}'}, 'person_identifier': 'AAAABBBBCCCCDDDD', 'dest_public_key': '-----BEGIN PUBLIC KEY-----\\nXQIDAQAB\n-----END PUBLIC KEY-----', 'channel_id': 'KKa8QqqTBGePJStJpQMbspEvvV4LJJCY', 'start_validity': None, 'expire_validity': None}]
    ...
    def test_message_failure_db_error(self):
        ...
        with patch('hgw_common.messaging.receiver.KafkaConsumer', MockKafkaConsumer), \
                patch('hgw_backend.models.OAuth2Authentication.create_connector', return_value=True) as mocked_create_connector, \
                patch('hgw_backend.management.commands.create_connector_consumer.Source', mock):
            self.set_mock_kafka_consumer(MockKafkaConsumer, self.messages, True)
            Command().handle()
