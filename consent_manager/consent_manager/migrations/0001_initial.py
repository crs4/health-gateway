# -*- coding: utf-8 -*-
# Generated by Django 1.11.16 on 2019-03-19 10:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('validity', models.DateTimeField(default=consent_manager.models.get_confirmation_code_validity_default)),
            ],
        ),
        migrations.CreateModel(
            name='Consent',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hgw_common.ProfileSection'),
        ),
    ]
